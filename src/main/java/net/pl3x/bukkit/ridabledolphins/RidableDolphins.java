...
public class RidableDolphins extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        RidableDolphins.verticalSpeedModifier = (float) getConfig().getDouble("speed-modifiers.vertical");
        RidableDolphins.horizontalSpeedModifier = (float) getConfig().getDouble("speed-modifiers.horizontal");
        RidableDolphins.forwardSpeedModifier = (float) getConfig().getDouble("speed-modifiers.forward");
    }
